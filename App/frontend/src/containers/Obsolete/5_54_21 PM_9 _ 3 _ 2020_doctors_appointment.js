...
// FETCHING DATA FOR COMPONENT
			axios.get(utils.baseUrl + '/doctors_appointments/doctors_appointments_list',)
			.then((response) => {
				this.props.set_fetched_doctors_appointments(response.data)
			})
			.catch((error) => {
				console.log(error);
			})
...
// RENDER METHOD
	render() {
		...
		const total_doctors_appointments = this.props.total_doctors_appointments
