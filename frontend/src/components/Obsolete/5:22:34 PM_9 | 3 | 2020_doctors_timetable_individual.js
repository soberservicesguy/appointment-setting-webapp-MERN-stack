...
class DoctorsTimetableIndividual extends Component {
	constructor(props) {
		super(props);
// STATE	
		this.state = {
...
DoctorsTimetableIndividual.defaultProps = {
	//:,
};

export default withRouter(withResponsiveness(withStyles(styles)(DoctorsTimetableIndividual)));
